        ...
        <form action="{{ route('brand.store') }}" method="POST">
          ...
          <div class="row g-3 mb-3">
            ...
            <div class="col-md-3">
              ...
              <input type="number" name="kilometer_age" value="{{ old('kilometer_age', $car->kilometer_age ?? '') }}"
            ...
            <div class="col-md-4">
              ...
              <input type="number" step="0.01" name="price" value="{{ old('price', $car->price ?? '') }}" class="form-control"
                required>
